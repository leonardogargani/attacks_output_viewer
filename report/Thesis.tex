...
% Do not change config_files/config.tex file unless you really know what you are doing. 
...
% TITLE PAGE
%-----------------------------------------------------------------------------
% Do not change config_files/TitlePage.tex (Modify it IF AND ONLY IF you need to add or delete the Co-advisors)
